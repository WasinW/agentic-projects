# การเทรดด้วย Divergence — คู่มือฉบับสมบูรณ์

## ข้อมูลเอกสาร (Document Metadata)
| ฟิลด์ | ค่า |
|---|---|
| **รหัสกลยุทธ์ (Strategy ID)** | DIV-001 |
| **หมวดหมู่ (Category)** | การวิเคราะห์โมเมนตัม / สัญญาณนำ (Momentum Analysis / Leading Signals) |
| **ประเภทสินทรัพย์ (Asset Classes)** | Forex, Crypto, หุ้น (Equities), สินค้าโภคภัณฑ์ (Commodities) |
| **กรอบเวลา (Timeframes)** | M15 ถึง Weekly (หลัก: H1–D1) |
| **ความซับซ้อน (Complexity)** | ระดับกลาง (Intermediate) |
| **ความเหมาะสมกับ AI** | สูงมาก — การเปรียบเทียบทางคณิตศาสตร์ระหว่างราคากับออสซิลเลเตอร์ |
| **เวอร์ชัน** | 2.0 |
