# Market Making Strategies — Complete Reference

## Document Metadata
| Field | Value |
|---|---|
| Strategy Class | Market Making / Liquidity Provision |
| Asset Classes | Forex, Crypto (CEX & DEX) |
| Timeframe | Sub-second to Minutes (High-Frequency) |
...
2. [Bid-Ask Spread Management](#2-bid-ask-spread-management)
3. [Inventory Risk Management](#3-inventory-risk-management)
4. [Avellaneda-Stoikov Model](#4-avellaneda-stoikov-model)
5. [Optimal Quote Placement](#5-optimal-quote-placement)
6. [Adverse Selection Management](#6-adverse-selection-management)
7. [Market Making on CEX vs DEX](#7-market-making-on-cex-vs-dex)
8. [High-Frequency Considerations](#8-high-frequency-considerations)
...
## 6. Adverse Selection Management
...
## 8. High-Frequency Considerations
...
*This document is part of the Multi-Agent AI Trading System knowledge base. Market making is a sophisticated, capital-intensive strategy that provides consistent returns through spread capture but requires excellent infrastructure, risk management, and adverse selection mitigation to be profitable.*
