# Carry Trade Strategies — Complete Reference

## Document Metadata
| Field | Value |
|---|---|
| Strategy Class | Carry Trade / Yield Differential |
| Asset Classes | Forex, Crypto (DeFi, Futures) |
| Timeframe | Multi-week to Multi-month |
...
## Table of Contents
1. [Interest Rate Differential Trading](#1-interest-rate-differential-trading)
2. [Forex Carry Trade](#2-forex-carry-trade)
3. [Crypto Carry Strategies](#3-crypto-carry-strategies)
4. [Funding Rate Carry](#4-funding-rate-carry)
5. [Staking and Lending Rate Differentials](#5-staking-and-lending-rate-differentials)
6. [Risk: Carry Trade Unwind](#6-risk-carry-trade-unwind)
7. [Sharpe Ratio of Carry Strategies](#7-sharpe-ratio-of-carry-strategies)
...
## 5. Staking and Lending Rate Differentials
...
## 7. Sharpe Ratio of Carry Strategies
...
*This document is part of the Multi-Agent AI Trading System knowledge base. Carry trades provide a steady income stream in favorable regimes but require disciplined risk management to survive the inevitable unwinds. Combining carry with trend/momentum filters significantly improves risk-adjusted returns.*
