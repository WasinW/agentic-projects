# Correlation Trading — Complete Reference

## Document Metadata
| Field | Value |
|---|---|
| Strategy Class | Correlation / Relative Value Trading |
| Asset Classes | Forex, Crypto, Cross-Asset |
...
## Table of Contents
1. [Correlation Matrix Analysis](#1-correlation-matrix-analysis)
2. [Rolling Correlation and Regime Changes](#2-rolling-correlation-and-regime-changes)
3. [Correlation Breakdown During Crises](#3-correlation-breakdown-during-crises)
4. [Dollar Smile Theory for Forex](#4-dollar-smile-theory-for-forex)
5. [Crypto Correlation Clusters](#5-crypto-correlation-clusters)
6. [Dispersion Trading](#6-dispersion-trading)
7. [Hedging Using Correlated Assets](#7-hedging-using-correlated-assets)
8. [Portfolio Construction Using Correlation](#8-portfolio-construction-using-correlation)
...
## 2. Rolling Correlation and Regime Changes
...
## 4. Dollar Smile Theory for Forex
...
## 7. Hedging Using Correlated Assets
...
## 8. Portfolio Construction Using Correlation
...
*This document is part of the Multi-Agent AI Trading System knowledge base. Correlation trading provides alpha by exploiting deviations from normal inter-asset relationships and enables better portfolio construction through understanding the dynamic correlation structure of markets.*
